...
export function generateReasonsMasterDisplay(componentList) {
                    ...
                    <div className="row pb-4">
                        <div className="col-12">
                            <div className='table-wrp background-white'>
                                <h5>All Reasons</h5>
                                <Grid item={componentList["gridReasons"]}
                                    customButton={<i className="fa fa-edit"></i>}
                                    deleteButton={<i className="fa fa-ban"></i>}
                                    className="table table-responsive table-striped table-sm w-100 d-block d-md-table">
                                    <div className="row">
                                        <div className="col-12">
                                            <div className="master-table-wrp">
                                                <GridHeader typeName="GridHeader" columns={componentList["gridReasons"].columns} />
                                                <GridBody typeName="GridBody" rows={componentList["gridReasons"].data} />
                                            </div>
                                        </div>
                                    </div>
                                </Grid>
