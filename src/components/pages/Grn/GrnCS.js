...
// Price
componentListConfig["inputPrice"] = {
...
componentListConfig["inputRmpoNoSearch"] = {
    objectType: "TextBox",
    schema: {
        name: "inputRmpoNoSearch",
        placeholder: "",
        type: "text",
        length: 100,
        showLabel: true,
