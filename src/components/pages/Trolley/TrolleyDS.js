...
export function generateTrolleyDisplay(componentList, handlers) {
                    ...
                    <div className="row">
                        <div className="col-12 d-flex justify-content-end">
                            <ControlCenter item={componentList["CONTROL_CENTER"]} >
                                ...
                                <Button className="btn common-btn common-btn-erp btn-sm mr-2" item={componentList["buttonUndo"]}>
                                    <i className="fas fa-undo fa-lg"></i>
                                </Button>
                                <button
                                    className="btn btn-secondary btn-sm"
                                    type="button"
                                    title="Print Trolley Stickers"
                    ...
                    <div className="row pb-4">
                        <div className="col-12">
                            <div className='table-wrp background-white'>
                                <Grid item={componentList["gridTrolley"]}
                                    ...
                                    <div className="row">
                                        <div className="col-12">
                                            <div className="master-table-wrp">
                                                <GridHeader typeName="GridHeader" columns={componentList["gridTrolley"].columns} />
                                                <GridBody typeName="GridBody" rows={componentList["gridTrolley"].data} />
                                            </div>
                                        </div>
                                    </div>
                                </Grid>
                                {totalCount === 0 &&
                                    <div className="text-center py-4" style={{ color: '#adb5bd' }}>
                                        No trolleys yet &mdash; use "New Trolley" to create the first one.
                                    </div>
                                }
                            </div>
                        </div>
