...
export function generateStockTransferDisplay(componentList, control) {
            ...
            <div className="page-header-wrp">
                ...
                <div className="row">
                    <div className="col-12 d-flex justify-content-end">
                        <ControlCenter item={componentList["CONTROL_CENTER"]} >
                            <Button className="btn common-btn common-btn-erp btn-sm mr-2" item={componentList["buttonSave"]}><i className="fas fa-save fa-md"></i></Button>
                        </ControlCenter>
                    </div>
                </div>
            </div>
                        ...
                        <div className="col-12">
                            <div className="form-row">
                                ...
                                <div className="form-group col-md-2 col-sm-12">
                                    <Label item={componentList["inputFromLocation"].label} />
                                    <TextBox item={componentList["inputFromLocation"]} className="form-control form-control-sm" />
                                </div>
                                ...
                                <div className="form-group col-md-2 col-sm-12">
                                    <Label item={componentList["inputToLocation"].label} />
                                    <TextBox item={componentList["inputToLocation"]} className="form-control form-control-sm" />
                                </div>
                                <div className="form-group col-md-2 col-sm-12">
                                    <Label item={componentList["inputQty"].label} />
                                    <NumberField item={componentList["inputQty"]} className="form-control form-control-sm" />
                                </div>
