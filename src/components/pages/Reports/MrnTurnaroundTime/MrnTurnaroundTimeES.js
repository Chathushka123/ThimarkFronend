...
import { generateMrnTurnaroundTimeDisplay } from './MrnTurnaroundTimeDS'
import config from './MrnTurnaroundTimeCS'
import API from '../../../../api/API'

const MrnTurnaroundTime = () => {
    ...
    async function handleRunReport() {
        ...
        try {
            const response = await API.get('/reports/mrn-turnaround-time', {
    ...
    async function handleDownloadCsv() {
        ...
        try {
            const response = await API.get('/reports/mrn-turnaround-time/download', {
                params: { query_type: queryType },
                responseType: 'blob',
            })

            let filename = `mrn_turnaround_time_q${queryType}.csv`
    ...
    return generateMrnTurnaroundTimeDisplay(
        config,
        { rows, columns, count, loading, error }
    )
}

export default MrnTurnaroundTime
