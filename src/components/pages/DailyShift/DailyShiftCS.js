...
gridDailyShiftsCols["team_name"] = { objectType: "TextBox", colIndex: 5, datatype: "text", name: "team_name", placeholder: "Team", editable: false, filterring: true, sqlColumn: "team_name", style: { textAlign: "left", minWidth: "160px", width: "160px" } };
gridDailyShiftsCols["team_start_date_time"] = { objectType: "TextBox", colIndex: 6, datatype: "text", name: "team_start_date_time", placeholder: "Team Start", editable: false, sqlColumn: "team_start_date_time", style: { textAlign: "left", minWidth: "150px", width: "150px" } };
gridDailyShiftsCols["team_end_date_time"] = { objectType: "TextBox", colIndex: 7, datatype: "text", name: "team_end_date_time", placeholder: "Team End", editable: false, sqlColumn: "team_end_date_time", style: { textAlign: "left", minWidth: "150px", width: "150px" } };
gridDailyShiftsCols["team_active"] = { objectType: "CheckBox", colIndex: 8, datatype: "checkbox", name: "team_active", placeholder: "Team Active", editable: false, checkedValue: "1", uncheckedValue: "0", sqlColumn: "team_active", style: { textAlign: "center", minWidth: "90px", width: "90px" } };
gridDailyShiftsCols["active"] = { objectType: "CheckBox", colIndex: 9, datatype: "checkbox", name: "active", placeholder: "Active", editable: false, checkedValue: "1", uncheckedValue: "0", sqlColumn: "active", style: { textAlign: "center", minWidth: "80px", width: "80px" } };
